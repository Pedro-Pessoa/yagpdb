...
type automodRuleDatumR struct {
	Rule                         *AutomodRule              `boil:"Rule" json:"Rule" toml:"Rule" yaml:"Rule"`
	TriggerAutomodTriggeredRules AutomodTriggeredRuleSlice `boil:"TriggerAutomodTriggeredRules" json:"TriggerAutomodTriggeredRules" toml:"TriggerAutomodTriggeredRules" yaml:"TriggerAutomodTriggeredRules"`
}
...
func (automodRuleDatumL) LoadRule(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAutomodRuleDatum interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`automod_rules.id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (q automodRuleDatumQuery) DeleteAllG(ctx context.Context) (int64, error) {
