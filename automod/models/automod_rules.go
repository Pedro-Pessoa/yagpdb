...
type automodRuleR struct {
	...
	RuleAutomodRuleData       AutomodRuleDatumSlice     `boil:"RuleAutomodRuleData" json:"RuleAutomodRuleData" toml:"RuleAutomodRuleData" yaml:"RuleAutomodRuleData"`
	RuleAutomodTriggeredRules AutomodTriggeredRuleSlice `boil:"RuleAutomodTriggeredRules" json:"RuleAutomodTriggeredRules" toml:"RuleAutomodTriggeredRules" yaml:"RuleAutomodTriggeredRules"`
	RuleAutomodViolations     AutomodViolationSlice     `boil:"RuleAutomodViolations" json:"RuleAutomodViolations" toml:"RuleAutomodViolations" yaml:"RuleAutomodViolations"`
}
...
func (automodRuleL) LoadRuleset(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAutomodRule interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`automod_rulesets.id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (automodRuleL) LoadRuleAutomodRuleData(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAutomodRule interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`automod_rule_data`),
		qm.WhereIn(`automod_rule_data.rule_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (automodRuleL) LoadRuleAutomodTriggeredRules(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAutomodRule interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`automod_triggered_rules.rule_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (automodRuleL) LoadRuleAutomodViolations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAutomodRule interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`automod_violations`),
		qm.WhereIn(`automod_violations.rule_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (q automodRuleQuery) DeleteAllG(ctx context.Context) (int64, error) {
