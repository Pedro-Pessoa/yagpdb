...
type automodTriggeredRuleR struct {
	...
	Trigger *AutomodRuleDatum `boil:"Trigger" json:"Trigger" toml:"Trigger" yaml:"Trigger"`
}
...
func (automodTriggeredRuleL) LoadTrigger(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAutomodTriggeredRule interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`automod_rule_data.id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (q automodTriggeredRuleQuery) DeleteAllG(ctx context.Context) (int64, error) {
