...
type customCommandGroupR struct {
	GroupCustomCommands CustomCommandSlice `boil:"GroupCustomCommands" json:"GroupCustomCommands" toml:"GroupCustomCommands" yaml:"GroupCustomCommands"`
}
...
func (customCommandGroupL) LoadGroupCustomCommands(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCustomCommandGroup interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`custom_commands.group_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (q customCommandGroupQuery) DeleteAllG(ctx context.Context) (int64, error) {
