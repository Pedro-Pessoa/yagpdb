...
func (customCommandL) LoadGroup(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCustomCommand interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`custom_command_groups.id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
