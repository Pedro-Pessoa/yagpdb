...
func (s *State) VoiceState(guildID, userID int64) (*VoiceState, error) {
	if s == nil {
		return nil, ErrNilState
	}
...
func (s *State) OnInterface(se *Session, i interface{}) (err error) {
	...
	case *PresenceUpdate:
		if s.TrackPresences {
			_ = s.PresenceAdd(t.GuildID, &t.Presence)
		}
		if s.TrackMembers {
...
func firstRoleColorColor(guild *Guild, memberRoles []int64) int {
