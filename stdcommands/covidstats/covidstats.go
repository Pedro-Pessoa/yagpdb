...
var Command = &commands.TIDCommand{
	...
	ArgSwitches: []*dcmd.ArgDef{
		{Switch: "countries", Name: "Countries of the World"},
		{Switch: "continents", Name: "The Continents of the World"},
		{Switch: "states", Name: "A State name in USA"},
		{Switch: "page", Name: "Go to page number, works for paginated output", Type: dcmd.Int},
		{Switch: "1d", Name: "Stats from yesterday"},
		{Switch: "2d", Name: "Stats from the day before yesterday (does not apply to states)"},
	},
