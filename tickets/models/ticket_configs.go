...
type (
	...
	// This should generally be used opposed to []TicketConfig.
...
// CountG returns the count of all TicketConfig records in the query, and panics on error.
...
func TicketConfigs(mods ...qm.QueryMod) ticketConfigQuery {
	...
	return ticketConfigQuery{NewQuery(mods...)}
}
...
func (o *TicketConfig) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
...
func (o *TicketConfig) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"ticket_configs\"", updateOnConflict, ret, update, conflict, insert)
